...
define Device/bananapi_bpi-r4-lite
  ...
  DEVICE_DTS_OVERLAY:= \
	mt7987a-bananapi-bpi-r4-lite-spim-nand \
	mt7987a-bananapi-bpi-r4-lite-spidev \
	mt7987a-bananapi-bpi-r4-lite-spim-nor \
  ...
  kmod-usb3 kmod-hwmon-pwmfan e2fsprogs f2fsck mkf2fs
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  KERNEL_IN_UBI := 1
  ...
  ARTIFACTS := \
	  emmc-gpt.bin emmc-preloader.bin emmc-bl31-uboot.fip \
	  emmc.img.gz \
	  snor-factory.bin snor-preloader.bin snor-bl31-uboot.fip \
	  snand-factory.bin snand-preloader.bin snand-bl31-uboot.fip \
	  sdcard.img.gz
  ARTIFACT/emmc-gpt.bin := mt798x-gpt emmc
  ARTIFACT/emmc-preloader.bin   := mt7987-bl2 emmc-comb
  ARTIFACT/emmc-bl31-uboot.fip   := mt7987-bl31-uboot $$(DEVICE_NAME)-emmc
  ARTIFACT/emmc.img.gz        := mt798x-gpt emmc |\
                                   pad-to 512k | mt7987-bl2 emmc-comb |\
                                   pad-to 6656k | mt7987-bl31-uboot $$(DEVICE_NAME)-emmc |\
                                ...
                                $(if $(CONFIG_TARGET_ROOTFS_SQUASHFS),\
                                  ...
                                  gzip
  ARTIFACT/snor-preloader.bin  := mt7987-bl2 nor-comb
  ARTIFACT/snor-bl31-uboot.fip := mt7987-bl31-uboot $$(DEVICE_NAME)-snor
  ARTIFACT/snor-factory.bin := mt7987-bl2 nor-comb | pad-to 2432k | \
	  		       mt7987-bl31-uboot $$(DEVICE_NAME)-snor | pad-to 3712k | \
			       append-image-stage initramfs-recovery.itb
  ARTIFACT/snand-preloader.bin  := mt7987-bl2 spim-nand-ubi-comb
  ARTIFACT/snand-bl31-uboot.fip := mt7987-bl31-uboot $$(DEVICE_NAME)-snand
  UBINIZE_PARTS := fip=:$(BIN_DIR)/openwrt-mediatek-filogic-bananapi_bpi-r4-lite-snand-bl31-uboot.fip
  UBINIZE_PARTS += recovery=:$(BIN_DIR)/openwrt-mediatek-filogic-bananapi_bpi-r4-lite-initramfs-recovery.itb
  ARTIFACT/snand-factory.bin := mt7987-bl2 spim-nand-ubi-comb | pad-to 256k | \
                                mt7987-bl2 spim-nand-ubi-comb | pad-to 512k | \
                                mt7987-bl2 spim-nand-ubi-comb | pad-to 768k | \
                                mt7987-bl2 spim-nand-ubi-comb | pad-to 2048k | \
                                ubinize-image fit squashfs-sysupgrade.itb
  ARTIFACT/sdcard.img.gz        := mt798x-gpt sdmmc |\
                                   pad-to 17k | mt7987-bl2 sdmmc-comb |\
                                   pad-to 6656k | mt7987-bl31-uboot $$(DEVICE_NAME)-sdmmc |\
                                   pad-to 44M | mt7987-bl2 spim-nand-ubi-comb |\
                                   pad-to 45M | mt7987-bl31-uboot $$(DEVICE_NAME)-snand |\
                                   pad-to 51M | mt7987-bl2 emmc-comb |\
                                   pad-to 52M | mt7987-bl31-uboot $$(DEVICE_NAME)-emmc |\
                                   pad-to 56M | mt798x-gpt emmc |\
                                $(if $(CONFIG_TARGET_ROOTFS_SQUASHFS),\
                                   pad-to 64M | append-image squashfs-sysupgrade.itb | check-size |\
                                ) \
